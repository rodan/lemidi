 ...
 */
#if !defined(__MAX3421_H__) || defined(_max3421e_h_)
#error "Never include max3421e.h directly; include max3421.h instead"
#else
...
#define     ICLRALLBITS (bmBUSEVENTIRQ | bmRWUIRQ | bmRCVDAVIRQ | bmSUSDNIRQ | bmCONNIRQ | bmFRAMEIRQ | bmHXFRDNIRQ)
